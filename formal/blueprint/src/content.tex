...
\begin{definition}[Bind]
  \label{def:union}\lean{Mensura.bind}\uses{def:table}\leanok
...
\begin{theorem}[Bind is commutative]
  \label{thm:union-comm}\lean{Mensura.bind_comm}\uses{def:union}\leanok
...
\begin{theorem}[Bind is associative]
  \label{thm:union-assoc}\lean{Mensura.bind_assoc}\uses{def:union}\leanok
...
\begin{theorem}[Bind weakens disjointness]
  \label{thm:union-disjoint-iff}\lean{Mensura.bind_disjoint_iff}\leanok
...
\begin{definition}[Row-wise flatMap]
  \label{def:flatMap}\lean{Mensura.map}\uses{def:table}\leanok
...
\begin{theorem}[Map is split-safe]
  \label{thm:flatMap-splitsafe}\lean{Mensura.map_splitSafe}\leanok
...
\begin{theorem}[Project inverts promote]
  \label{thm:demote-promote}\lean{Mensura.demote_ungroup}\leanok
...
\begin{theorem}[Ungroup inverts demote]
  \label{thm:promote-demote}\lean{Mensura.promote_project}\leanok
  \uses{def:promote, def:demote}
...
\begin{theorem}[A non-dropping flatMap preserves the rectangle]
  \label{thm:flatMap-exhaustive}\lean{Mensura.map_exhaustive}\leanok
...
\begin{theorem}[Bind preserves the rectangle]
  \label{thm:union-exhaustive}\lean{Mensura.bind_exhaustive}\leanok
